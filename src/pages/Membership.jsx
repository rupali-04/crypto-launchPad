...
const Membership = () => {
    ...
    const d2 = {type: "IDO SPECIAL",price: "$250",total:"5 IDOs",description: "This plan helps you with IDOs Investment benifits that helps you to get some exclusive benifits for the IDOs", h1: "Investment Limit", value1: "$1000 Per IDOs", h2: "Early Access", value2: "24 Hr", h3: "Time Limit", value3: "NO" };
    ...
    <Flex flexWrap={"wrap"} ml="3rem"  w="100%"  flexDirection={"column"}>
        ...
        <Text fontSize="14px" color={"gray.500"}>Select a plan that will best fit for your need</Text>
            ...
            <MembershipCard data={d1} />  <MembershipCard data={d2} />
