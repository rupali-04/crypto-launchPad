...
<Link to="/admin/dashboard/airdrop"><Button  borderRadius={"0"} pl="2rem" pr="2rem" >ADD NEW AIRDROP</Button></Link>
  ...
  <Link to="/admin/dashboard/airdrop/close"><Button bg="#1F94FF" borderRadius={"0"} color="white"  pl="2rem" pr="2rem">CLOSE AIRDROP</Button></Link>
  </ButtonGroup>
<Spacer />
...
export default AdminAirdropClose;