...
<Link to="/admin/dashboard/ido"><Button  borderRadius={"0"} pl="2rem" pr="2rem" >ADD NEW PROJECT</Button></Link>
  ...
  <Link to="/admin/dashboard/ido/close"><Button borderRadius={"0"}  pl="2rem" pr="2rem" bg="#1F94FF" color="white">CLOSE PROJECT </Button></Link>
  </ButtonGroup>
<Spacer />
...
<Flex mt="1rem" ml="3rem" gap="4" wrap={"wrap"}>
            <AdminProjectCard/> <AdminProjectCard/> <AdminProjectCard/>
